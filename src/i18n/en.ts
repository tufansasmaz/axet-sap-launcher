...
export const en: Record<TranslationKey, string> = {
  ...
  "workDir.adopted": "My working folder is now `{dir}`. I can read and write the files here directly.",
  "workDir.skills": "{count} skills installed into this folder.",
  "workDir.blockedByTier": "Catalog skills removed by the gate (PRD or role): {names}",
  "workDir.failed": "Working folder could not be changed: {message}",
  ...
  "roleModal.lockedHint": "Installed, but refuses to write to SAP because this system is not DEV",
  "roleModal.lockedNotice":
    "This system is not marked as development (DEV). {count} write-capable skills will be installed but run read-only here: writes, activation and deploys happen only on a DEV system.",
  "tierPrompt.title": "Which system is this?",
  "tierPrompt.subtitle": "{system} is not marked yet. Writing to SAP (development, activation, deploy) is only enabled on a development system.",
  "tierPrompt.option.DEV": "Development system — writes enabled",
  "tierPrompt.option.QA": "Quality / test system — read-only",
  "tierPrompt.option.PRD": "Production system — read-only",
  "tierPrompt.desc.DEV": "The agent can generate code and screens, activate and deploy. The transport request is confirmed before every write.",
  "tierPrompt.desc.QA": "Read, search, analyse. Write tools are off; reading personal-data tables needs approval.",
  "tierPrompt.desc.PRD": "Read, search, analyse. Write tools are off; reading personal-data tables needs approval.",
  "tierPrompt.guessHint": "(guessed from name)",
  "tierPrompt.changeLater": "The choice is saved for this system; you can change it from the badge in the system panel.",
  "tierPrompt.skip": "Not now (read-only)",
  "tierPrompt.confirm": "Save and continue",
  "tierPrompt.saveFailed": "Could not save the system tier, connecting read-only: {message}",
  ...
  "readiness.sectionContext": "What the agent sees",
  "sapContext.hint": "This is the only file the agent gets on the SAP side. It is regenerated on every connect; it cannot be edited here.",
  "sapContext.refresh": "Refresh",
  "sapContext.reveal": "Show in folder",
  "sapContext.missing": "Not generated yet — this file appears once you connect to a SAP system.",
  "sapContext.lines": "{count} lines",
  "sapContext.updated": "Updated: {time}",
  "sapContext.notesKept": "Your own notes are preserved",
  "sapContext.truncated": "The file is long; only the beginning is shown here.",
