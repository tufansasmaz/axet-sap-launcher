export const tr = {
  ...
  "workDir.adopted": "Çalışma klasörüm artık `{dir}`. Buradaki dosyaları doğrudan okuyup yazabilirim.",
  ...
  "systemPanel.addressLabel": "Adres",
  "systemPanel.adtUrlLabel": "ADT Adresi",
  "systemPanel.routerLabel": "SAProuter",
  "systemPanel.uuid": "UUID",
  "systemPanel.copyAddress": "Adresi kopyala",
  "systemPanel.copyAdtUrl": "ADT adresini kopyala",
  ...
  "systemPanel.openInAxetDesc": "Bağlan ve bu sistem için bir sohbet aç",
  ...
  "axetCodeHome.toolView": "Dosya okuyor",
  "axetCodeHome.toolEdit": "Dosya düzenliyor",
  "axetCodeHome.toolWrite": "Dosya yazıyor",
  "axetCodeHome.toolBash": "Komut çalıştırıyor",
  "axetCodeHome.toolGlob": "Dosya arıyor",
  "axetCodeHome.toolGrep": "İçerikte arıyor",
  "axetCodeHome.toolLs": "Klasöre bakıyor",
  "axetCodeHome.toolFetch": "İnternetten okuyor",
  "axetCodeHome.toolAgent": "Alt ajan çalıştırıyor",
  ...
  "roleModal.lockedHint": "Kurulur ama bu sistem DEV olmadığı için SAP'a yazmayı reddeder",
  "roleModal.lockedNotice":
    "Bu sistem geliştirme (DEV) olarak işaretli değil. Sisteme yazabilen {count} yetenek kurulacak ama burada salt okunur çalışacak: yazma, aktivasyon ve deploy yalnızca DEV sisteminde yapılır.",
  "tierPrompt.title": "Bu sistem hangisi?",
  "tierPrompt.subtitle": "{system} henüz işaretlenmemiş. SAP'a yazma (geliştirme, aktivasyon, deploy) yalnızca geliştirme sisteminde açılır.",
  "tierPrompt.option.DEV": "Geliştirme sistemi — yazma açık",
  "tierPrompt.option.QA": "Kalite / test sistemi — salt okunur",
  "tierPrompt.option.PRD": "Canlı sistem — salt okunur",
  "tierPrompt.desc.DEV": "Ajan kod ve ekran üretebilir, aktive edebilir, deploy edebilir. Her yazmadan önce taşıma kaydı sorulur.",
  "tierPrompt.desc.QA": "Okuma, arama, analiz. Yazan araçlar kapalı; KVKK tablolarında okuma onaya bağlı.",
  "tierPrompt.desc.PRD": "Okuma, arama, analiz. Yazan araçlar kapalı; KVKK tablolarında okuma onaya bağlı.",
  "tierPrompt.guessHint": "(adından tahmin)",
  "tierPrompt.changeLater": "Seçim bu sistem için saklanır; sistem panelindeki rozetten değiştirebilirsin.",
  "tierPrompt.skip": "Şimdi değil (salt okunur)",
  "tierPrompt.confirm": "Kaydet ve devam et",
  "tierPrompt.saveFailed": "Sistemin önem derecesi kaydedilemedi, salt okunur bağlanılacak: {message}",
  ...
  "settingsModal.shellHelper": "Alttaki terminal panelinde + ile açtığın sekmelerde kullanılacak kabuk. Harici pencere hiç açılmaz.",
  ...
  "addSystemModal.diagPortInvalid": "Port 1–65535 arasında bir sayı olmalı.",
  ...
  "addSystemModal.adtUrlOnprem": "ADT / ICM HTTPS Adresi",
  "addSystemModal.adtUrlOnpremPlaceholder": "örn. https://sunucu.firma.local:44300",
  "addSystemModal.adtUrlOnpremHelper": "İsteğe bağlı. Doldurursan port keşfi hiç yapılmaz, doğrudan bu adres kullanılır — sistemin ADT adresini zaten biliyorsan bağlanma süresini belirgin şekilde kısaltır.",
  ...
  "sapContext.hint": "SAP tarafında ajana giden tek dosya bu. Her bağlanışta yeniden üretiliyor; buradan düzenlenmez.",
  "sapContext.refresh": "Yenile",
  "sapContext.reveal": "Klasörde göster",
  "sapContext.missing": "Henüz üretilmemiş — bu dosya bir SAP sistemine bağlanıldığında oluşuyor.",
  "sapContext.lines": "{count} satır",
