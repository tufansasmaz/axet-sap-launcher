...
> yapabilecek tek yetenektir. **ADT tarafındaki tier kapısı buraya UZANMIYOR:** bir
> sistemi QA/PRD işaretlemek `adt_push`'u kapatır, SAP GUI'de basılan Kaydet tuşunu
> kapatmaz. Tek kapı bu kural:
>
